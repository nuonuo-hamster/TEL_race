...
# button server
gnome-terminal -- bash -c "sudo /home/ical/.local/share/virtualenvs/TEL2024_Integral-3zXHjaFF/bin/python "/home/ical/Desktop/nuonuo/TEL2024_Integral/ServerControl_button.py"; echo 'press any key to exit...'; read"
# wheel server
